...
<script>
  export default {
    ...
    data: () => ({
      ...
      itemsVentePromo: [
        {titre:'Top vente de minerais Dofus', description:'1000 unités de minerais + 1000 unités de bois + 1000 kamas', prix:'50',src:'BAUXITE.png'},
        {titre:'Top vente de bois Dofus', description:'100 unités de bois', prix:'5',src:'chene.png'},
        {titre:'Top vente de bois Dofus', description:'100 unités de fer', prix:'10',src:'noyer.png'},
        {titre:'Top vente de bois de Charmes', description:'100 unités de bois', prix:'10',src:'charme.png'},
        {titre:'Top vente de minerais Dofus', description:'100 unités d\' olivier', prix:'20',src:'olivier.png'},
        {titre:'Top vente de silicate ', description:'1000 unités de silicate', prix:'20',src:'SILICATE.png'},
      ],
      itemsVentePack: [
